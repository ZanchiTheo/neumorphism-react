...
const NeoButton = ({
  ...
  return (
    ...
    >
      {children}
      {gradient && (
        <Radial clicked={clicked} blur={ratioBlur} expanse={ratioEpanse} />
      )}
    </ButtonWrapper>
  );
};
...
const ButtonWrapper = styled.button`
  ...
  box-shadow: 8px 8px 13px #b4b4b4, -8px -8px 13px #e4e4e4,
    inset 0px 0px 0px #b4b4b4, inset 0px 0px 0px #e4e4e4;
  margin: auto;
  ...
  outline: none;
  &:active {
    box-shadow: 0px 0px 0px #b4b4b4, 0px 0px 0px #e4e4e4,
...
const Radial = styled.div`
  ...
  box-shadow: ${props =>
    props.clicked
      ? `0px 0px ${props.blur}px ${props.expanse}px rgba(153, 42, 18,0.4)`
      : "none"};
`;
